...
Slice 1 — `docs/migration_bar_history_timescale.md#install` + `scripts/setup_timescale_wsl.sh` idempotente para subir Postgres 16 + TimescaleDB no WSL. **Não toca a app.**
